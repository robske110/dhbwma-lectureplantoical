...
class IcalRenderer extends LecturePlanRenderer{
	public function renderContent(): string{
		$lectures = $this->lecturePlan->getLecturesForCourseBetween($this->courseName, $this->start, $this->end);
		...
		foreach($lectures as $lecture){
			...
			$event = (new Event())
				...
				->setOccurrence(
					new TimeSpan(new DateTime($lecture->start, true), new DateTime($lecture->end, true))
				);
